...
const s_stylePath = "/_commentbox/comment-widget-pink.css";
const s_formId = "1FAIpQLSdQbUUwN5K9NJe2CP6IgvjUCRHFNQtVJfoOvVv1-cA54Wt1Og";
const s_nameId = "86721912";
const s_websiteId = "1543355766";
const s_textId = "706807800";
const s_pageId = "895994800";
const s_replyId = "1542906682";
const s_sheetId = "1lbZBod1WgW2b9uq58jxPvUaa1kvroy7tkWp6dwI3Npw";
...
const s_submitButtonLabel = "Submit comment";
...
function createComment(data) {
  ...
  if (data.Website) {
    ...
    symbol.innerHTML = "<img src='/_images/assets/pixels/bullet.png' alt=''>";
    symbol.className = "c-symbol";
    comment.appendChild(symbol);
