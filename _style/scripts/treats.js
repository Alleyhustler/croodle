gsap.set(".cookie img.swipeimage", { yPercent: -20, xPercent: -50 });

let activeImage;
gsap.utils.toArray(".cookie").forEach((el) => {
  ...
  el.addEventListener("mouseenter", (e) => {
    ...
    activeImage = image;
    (setX = gsap.quickTo(image, "x", { duration: 0.1, ease: "power3" })), (setY = gsap.quickTo(image, "y", { duration: 0.1, ease: "power3" }));
    align(e);
  });
